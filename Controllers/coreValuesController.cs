...
namespace MIS4200Team8v2.Controllers
{
    public class coreValuesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "valueID,valueName,MyProperty")] coreValues coreValues)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "valueID,valueName,MyProperty")] coreValues coreValues)
        {
            if (ModelState.IsValid)
            {
